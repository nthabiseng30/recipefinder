  ...
  return (
    <footer className="text-white py-20 bg_gradient">
      <div className="container mx-auto px-20 lg:px-20 py-20 flex flex-col gap-10 md:flex-row justify-between border-t border-slate-800">
        <div className="flex">
          <p className="font-bold text-center"> Recipe<span className="text-purple-500 text-xl">Rover</span> </p>
        </div>
        <div className="">
          <p>QUICK LINKS</p>
      ...
      <div className="flex items-center justify-center py-10">
        <span className="text-gray-400 leading-10">Nthabiseng Mahlangu&copy; 2023</span>
      </div>
    </footer>
  );
};
